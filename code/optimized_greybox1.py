...
class Organizer():
    ...
    def federated_training_nontarget_ada_grey_box(self, logger, adaptive=False, record_process=True,
...
logger = make_logger("project", EXPERIMENTAL_DATA_DIRECTORY,
                     'log_{}_{}_{}_TrainEpoch{}_AttackEpoch{}_greybox_misleading_optimized'.format(TIME_STAMP, DEFAULT_SET, DEFAULT_AGR,
                                                                               TRAIN_EPOCH,
                                                                               MAX_EPOCH - TRAIN_EPOCH))
org = Organizer()
org.set_random_seed()
org.federated_training_nontarget_ada_white_box(logger)